...
export default function Header() {
  ...
  return (
    <>
      {/* Top Bar */}
      <div className="bg-primary-dark border-b border-primary text-white text-sm py-2 relative overflow-hidden">
        {/* Animated background elements */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-secondary/5 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-0 left-0 w-48 h-48 bg-secondary/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        </div>
        <div className="container-custom relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-2">
            <div className="flex flex-col md:flex-row items-center gap-4 text-xs md:text-sm">
        ...
        <div className="container-custom relative z-10">
          <div className="flex items-center justify-between py-4">
            ...
            <div className="hidden md:flex items-center gap-2 flex-shrink-0 ml-1">
              ...
              <a href="#contact" className="btn-primary text-sm shadow-lg">
          ...
          {isMenuOpen && (
            <div className="md:hidden pb-4">
              <div className="flex flex-col gap-4">
                ...
                <a href="#contact" className="btn-primary text-sm w-fit" onClick={() => setIsMenuOpen(false)}>
                  {t('header.callUs')}
                </a>
              </div>
            </div>
